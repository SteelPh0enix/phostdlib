...
void is_sorted() {
  ...
  phoenix::test::eq(phoenix::is_sorted(sorted.cbegin(), sorted.cend(), phoenix::is_greater), true,
                    "Sorted container is not sorted?");
  phoenix::test::eq(phoenix::is_sorted(sorted.cbegin(), sorted.cend(), phoenix::is_lesser), false,
                    "Sorted container is sorted reverse way?");
  phoenix::test::eq(phoenix::is_sorted(not_sorted.cbegin(), not_sorted.cend(), phoenix::is_greater), false,
                    "Unsorted container is sorted ascending!");
  phoenix::test::eq(phoenix::is_sorted(not_sorted.cbegin(), not_sorted.cend(), phoenix::is_lesser), false,
